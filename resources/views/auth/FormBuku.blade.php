                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="card card-primary">
                                                            ...
                                                            <!-- form start -->
                                                            <form
                                                                action="{{ url('dashboardd/koleksibuku/FormBuku/store') }}"
                                                                method="POST" role="form" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="no_inventaris_buku">No Inventaris</label>
                                                                    <input type="text" class="form-control @error('no_inventaris_buku') is-invalid @enderror" id="no_inventaris_buku" name="no_inventaris_buku" placeholder="No Inventaris">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="no_registrasi_buku">No Inventaris</label>
                                                                    <input type="text" class="form-control @error('no_registrasi_buku') is-invalid @enderror" id="no_registrasi_buku" name="no_registrasi_buku" placeholder="No Registrasi">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" id="abstrak"
                                                                        name="abstrak" placeholder="abstrak"></textarea>
                                                                </div>
                                                                <div class="form-group">
